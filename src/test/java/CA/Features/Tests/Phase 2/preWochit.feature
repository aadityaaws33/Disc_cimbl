@Regression @Phase2 @preWochit @JESS
...
Scenario Outline: Validate Single File Upload [Data Filename: <DATAFILENAME>][Stage: <STAGE>]
    ...
    * configure afterScenario =
    ...
    Examples:
        ...
        | promo_generation_DK_teaser_combi.xml          | promo_generation_qa.json    | preWochit           |  false              | 3000     |
        | promo_generation_NO_episodic_dp_1.xml         | promo_generation_qa.json    | preWochit           |  false              | 5000     |
        | promo_generation_NO_prelaunch_combi.xml       | promo_generation_qa.json    | preWochit           |  false              | 7000     |
        | promo_generation_FI_bundle_dp.xml             | promo_generation_qa.json    | preWochit           |  false              | 9000     |
        | promo_generation_FI_launch_combi.xml          | promo_generation_qa.json    | preWochit           |  false              | 11000    |
        | promo_generation_SE_film_dp.xml               | promo_generation_qa.json    | preWochit           |  false              | 13000    |
